...
console.log(header)
//tag, class 등과 같이 다수가 존재할 수 있는 대상을 DOM으로 선택하염 특정 대상 1개만 잡히는 게 아닌 Collection기분으로 여러개가 잡히기 때문에 원하는 대상 사용 시 정확히 그 대상을 인덱스로 선택해야 한다.
...
//버튼 클릭 시 아래 함수 호출하기
function btn_func1(){
    //위 변수에 대한 데이터타입 출력하기(콘솔 한 줄씩 입력)
...
function btn_func4(){
    ...
    //"요청사항은 oooo, 주문수량은 0개, 총 결제금액은 oooo원 입니다."
    //제품 1개당 1000원 기준
