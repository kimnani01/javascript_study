//타이머 함수
//setInterval() 일정시간 반복 타이버
//setInterval 타이머함수는 단독사용도 가능하지만 초기 생성 시 다른 변수에 담아두면 버튼 등의 이벤트로 제어가 가능하기 때문에 변수에 감아 생성하는 것을 추천한다.
...
function slide_timer_func(){
    ...
    //slide_num기준 : 1-2-0-1-2-0-1-2-0-1-2-0-1-2 반복
    slide_num++
