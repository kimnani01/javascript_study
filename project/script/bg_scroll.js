...
//a태그는 고유의 href 속성으로 특정 주소로 이동한다는 특징이 있어서 js click처리를 먼저 해야하는지? href속성 처리를 먼저 해야하는지? 구분을 못해서 스크롤이 위로 올라가는 문제가 생긴다.
//a태그에 js click 이벤트를 줄 때 href속성의 기능을 막아야 정상 작동한다.
